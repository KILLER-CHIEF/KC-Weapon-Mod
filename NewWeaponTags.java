...
public class NewWeaponTags { //This code is a bunch of examples and specific methods for particular weapon properties required in Halocraft that isn't in the ProjectileProperties class in KCWM (really its just hard-coded properties)
